...
from autoagent.core.runtime.scheduler import EdgeActivation, NodeExecutionTransition
...
class Scheduler:
    ...
    def initialize(self, *, workflow_ir: WorkflowIR, invocation: Invocation) -> None:
        ...
        for entry_node_id in workflow_ir.entry_node_ids:
            ...
            for edge_id in outgoing_edge_ids:
                ...
                affected_targets.append(edge.to_node)
    ...
    def _resolve_targets(
        ...
        *,
        ...
        pending_targets = self._ordered_targets(
            workflow_ir=workflow_ir,
            target_node_ids=target_node_ids,
        )
        while pending_targets and invocation.state != "failed":
            target_node_id = pending_targets.pop(0)
            if (
    ...
    def _ordered_targets(
        ...
        *,
        ...
        """Return unique target ids in compiled Workflow node declaration order."""

        target_set = set(target_node_ids)
        return [node_id for node_id in workflow_ir.nodes if node_id in target_set]
