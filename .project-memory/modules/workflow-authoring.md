...
Workflow owns ordered Node and Edge definitions plus Workflow-wide policy and non-semantic metadata. Nodes bind direct callables, Operators, Capability references, SystemCommands, or child Workflows. Edges express dependencies and optional conditions or Map policy. Input Mapping, Conditions, selectors, and aggregators receive restricted read views; Output Binding receives a transactional writable context whose changes are committed only after success.
