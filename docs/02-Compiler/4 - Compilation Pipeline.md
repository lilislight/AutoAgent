...
- Should each stage expose internal artifacts for debugging?
- Should incremental recompilation be supported after small patches?
- Should Workflow IR be cached by Workflow content hash?
- Should nested Workflow compilation be eager or lazy?